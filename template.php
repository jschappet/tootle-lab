 ...
 */
function tootletemp_html_head_alter(&$head_elements) {
 ...
 */
function tootletemp_preprocess_search_block_form(&$vars) {
 ...
 */
function tootletemp_preprocess_html(&$vars) {
 ...
 */
function tootletemp_breadcrumb($vars) {
